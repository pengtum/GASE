...
|---|---|---|
| **Module 1** — Two-loop architecture with embedded geographic knowledge | `geoevolve_package/` | LLM-driven evolution engine. Adopted from GeoEvolve (Luo et al. 2025) and used via the `geoevolve` Python package. |
